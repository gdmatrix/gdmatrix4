 ...
 */
@ApplicationScoped
public class GlobalSetup extends AbstractSetup
{
  String adminUserId = "admin";
  String adminPassword = "changeme";
  String autoLoginUserId = "autoLoginUserId";
  ...
  public void setAutoLoginUserId(String autoLoginUserId)
  {
  ...
  {
    return new Credentials(adminUserId, adminPassword);
  }
}
